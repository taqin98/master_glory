...
<html lang="en">
  <head>
    ...
    <?php if (!empty($css_plugins) ): ?>
        <link rel="stylesheet" type="text/css" href="<?= base_url('assets/dist/'.$css_plugins) ?>" />
    <?php endif; ?>
    <style>
      .bd-placeholder-img {
        font-size: 1.125rem;
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">PENGAJUAN IZIN</a>
  ...
  <div class="navbar-nav">
    <div class="nav-item text-nowrap">
      <a class="nav-link px-3" href="<?= base_url('auth/signout') ?>">Sign out</a>
    </div>
  </div>
</header>
<?php
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link <?= $nav1 ?>" aria-current="page" href="<?= base_url('main') ?>">
              <span data-feather="home" class="align-text-bottom"></span>
              Dashboard
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?= $nav2 ?>" href="<?= base_url('main/form_pengajuan') ?>">
